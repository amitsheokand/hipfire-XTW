...
(`HIPFIRE_QWEN_MTP=1` required; `--spec mtp` alone is AR) vs AR 36.6
on the default relativity prompt. DFlash 2 fires; τ does not become
tok/s on that prose cell. Do not assume transfer onto Whittle.
