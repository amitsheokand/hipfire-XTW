...
pub(crate) fn is_batchable_la(dt: DType, arch: &str) -> bool {
    ...
    // Native qt=51 GEMM (fused gate+up; QKV/QKVZA still overwrite). Kernel
...
fn moe_ffn_batched_admissible_for_dtypes(
    ...
    if admit_mq6 {
        ...
        let experts_ok = matches!(
            ...
            dtypes.expert_down,
            DType::MQ4G256 | DType::MQ4G256V2 | DType::MQ6G256 | DType::Q8_0
        );
        ...
        matches!(dtypes.shared_expert_gate, DType::MQ4G256 | DType::MQ4G256V2)
            ...
            && matches!(
                dtypes.expert_down,
                DType::MQ4G256 | DType::MQ4G256V2 | DType::Q8_0
            )
    }
}
...
/// Overwrite GEMM for native qt=51 `FP8E4M3G256`. gfx1201-only at the
...
pub(crate) fn prefill_moe_ffn_body_batched(
    ...
    // and MQ6/PARO/MQ4V2 keep the fused GEMV.
    ...
    match w.gpu_dtype {
        ...
        other => Err(hip_bridge::HipError::new(
            ...
            &format!(
             ...
             MQ4/MQ4V2/MQ4C/HFQ4, MQ6/HFQ6, MQ6/5/3/2V2, Q8_0, and FP8E4M3G256 mixes are wired. Re-quantize with \
